package club.ss220.manager.feature.members.controller;

import club.ss220.core.shared.GameBuild;
import club.ss220.core.shared.MemberData;
import club.ss220.manager.feature.members.view.MemberInfoView;
import club.ss220.manager.model.MemberTarget;
import club.ss220.manager.service.MemberResolutionService;
...
public class MemberInfoController {
    ...
    private final MemberResolutionService memberResolutionService;
    ...
    public void showMemberInfo(InteractionHook hook, User viewer, MemberTarget target, boolean isConfidential) {
        try {
            Optional<MemberData> memberOptional = memberResolutionService.resolve(target);
