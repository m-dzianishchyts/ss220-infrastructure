...
public class StatusView {
    ...
    private static String statusLevelDescription(ApplicationStatus.Level level) {
        return switch (level) {
            case OK -> "Всё в порядке";
            case WARNING -> "Обнаружены проблемы";
            case CRITICAL -> "Обнаружены критические проблемы";
        };
    }
}
